...
gmAccount.prototype = {
  ...
  get newMail() {
    return this.unread > this._lastUnread;
  },
  get unread() {
    var unread = 0;
  ...
  get status() {
    return (this._service ? this._service.status : null);
  },
  get loggedIn() {
    return (this._service ? this._service.loggedIn : false);
  },
  get checking() {
    return (this._service ? this._service.checking : false);
  },
  get inboxUnread() {
    return (this._service ? this._service.inboxUnread : -1);
  },
  get importantUnread() {
    return (this._service ? this._service.wrappedJSObject.importantUnread : -1);
  },
  get savedDrafts() {
    return (this._service ? this._service.savedDrafts : -1);
  },
  get spamUnread() {
    return (this._service ? this._service.spamUnread : -1);
  },
  get spaceUsed() {
    return (this._service ? this._service.spaceUsed : null);
  },
  get percentUsed() {
    return (this._service ? this._service.percentUsed : null);
  },
  get totalSpace() {
    return (this._service ? this._service.totalSpace : null);
  },
